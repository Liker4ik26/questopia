...
abstract class Routes {
  ...
  static router(BuildContext context) => GoRouter(
        ...
        redirect: (context, state) {
          ...
          final isAuth = authCubit.state.session != null;
          final isSignIn = state.fullPath == signInRoute;
          if (isSignIn) {
            return isAuth ? homeRoute : signInRoute;
          }
          final isSignUp = state.fullPath == signUpRoute;
          if (isSignUp) {
            return isAuth ? homeRoute : signUpRoute;
          }
          return isAuth ? null : signInRoute;
        },
        routes: [
