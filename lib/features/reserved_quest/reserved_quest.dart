  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => DeleteBloc(
          reservedQuestRepository: context.read<ReservedQuestRepository>()),
      child: Builder(
        builder: (context) {
          return Scaffold(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return BlocListener<DeleteBloc, DeleteState>(
                                ...
                                listener: (context, state) {
                                  if (state is DeleteReservedQuestSuccessState) {
                                    context.read<ReservedQuestBloc>().add(
                                        const LoadQuestsEvent(completer: null));
                                  }
                                },
                                child: ReservedQuestCard(
                                  onTap: () => context.pushNamed(
                                    'quests',
                                    pathParameters: {
                                      'questId': state
                                          .reservedQuests[index].idSlot.idQuest.id
                                    },
                                  ),
                                  questDomain: quest,
                                ),
